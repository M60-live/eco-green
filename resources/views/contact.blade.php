...
@section('content')
    ...
    <div class="page-banner overlay-secondery-8" style="background: url(images/contact.jpg) bottom center/ cover; padding: 150px 0;">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="text-area color-white w-50 lg-w-80 md-w-100 d-table mx-auto mt-20">
                            <p>Feel free to enquire about anything and we will respond. Ensure your details a correct so that we can reach you.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="contact-info md-mt-50">
                        ...
                        <ul class="color-secondery">
                            <li>
                                Phone :
                                <span>+233 245 142 414 / +233 244 660 454</span>
                            </li>
                            <li>
                                Email :
                                <span>info@ecogreenguard.com</span>
                            </li>
                            <li>
                                Address :
                                <span>ECO GREEN GUARD LTD<br>Accra, Ghana</span>
                            </li>
                        </ul>
                    </div>
                </div>
