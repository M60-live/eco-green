            ...
            <div class="row h-100">
                <div class="col-md-12 col-lg-12 h-100">
                    <div class="banner-content y-middle color-dark z-index-1 w-60 lg-w-80 position-relative">
                        ...
                        <p class="my-15">Providing solutions across critical sectors, supporting environmental
                            protection, public health, and industrial growth.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-4">
                    <div
                        ...
                        <a class="mt-20 d-inline-block flat-small icon-secondery btn-icon" href="#"><i
                                class="flaticon-right"></i></a>
                    </div>
                </div>
                <div class="col-md-12 col-lg-4">
                    <div
                        class="box-style-4 py-40 px-30 lg-mt-30 bg-white shadow-thik-black-01-hov transition-5 hov-trans-b-t-5 shadow-smooth-black-01">
                        <div class="round-xl-radius flat-large icon-white bg-primary">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-4 col-xl-5">
                    <div class="grow-business-img z-index-1 position-relative"><img src="images/partnership.jpg"
                                                                                    alt="image"></div>
                </div>
                <div class="col-md-12 col-lg-8 col-xl-7">
                    <div class="grow-info">
                        ...
                        <p>ECO GREEN GUARD LTD partners with global manufacturers, research institutions, and technology
                            ...
                            brands.</p>
                        {{--                    <p class="mt-15">Primis dis potenti sociosqu ac consequat sit litora hymenaeos id sociosqu penatibu preti lacus id torquent sollicitudin torquent est porttit semper quisque lacinia sem facilisis.</p>--}}
                ...
                <div class="col-md-12 col-lg-12 col-xl-12">
                    <div class="box-style">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                                <div
                                    class="box-style-3 position-relative flat-large icon-primary py-40 px-30 bg-white shadow-thik-black-01-hov transition-5 hov-trans-b-t-5 shadow-smooth-black-01 md-mt-30">
                                    {{--                                <i class="flaticon-consultation"></i>--}}
                                    <a href="service-details.html">
                                        <h4 class="box-title-3 my-20 d-inline-block">Environmental & Water
                                            Management</h4>
                                    </a>
                                    <ul class="list-group">
                                        <li class="list-group-item">Environmental Impact Assessments (EIA)</li>
                                        <li class="list-group-item">Water Resource Assessment & Hydrogeological
                                            Surveys
                                        </li>
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                                <div
                                    class="box-style-3 position-relative xl-mt-30 lg-mt-30 flat-large icon-primary py-40 px-30 bg-white shadow-thik-black-01-hov transition-5 hov-trans-b-t-5 shadow-smooth-black-01">
                                    {{--                                <i class="flaticon-insurance-1"></i>--}}
                                    <a href="service-details.html">
                                        <h4 class="box-title-3 my-20 d-inline-block">EHS & Waste Management</h4>
                                    </a>
                                    <ul>
                                        <li class="list-group-item">Environmental, Health & Safety (EHS) Audits and
                                            Systems Design
                                        </li>
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                                <div
                                    class="box-style-3 position-relative flat-large icon-primary py-40 px-30 bg-white shadow-thik-black-01-hov transition-5 hov-trans-b-t-5 shadow-smooth-black-01 mt-30">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                                <div
                                    ...
                                    {{--                                <i class="flaticon-banking"></i>--}}
                                    <a href="service-details.html">
                                        <h4 class="box-title-3 my-20 d-inline-block">Construction & Project
                                            Management</h4>
                                    </a>
                                    <ul class="list-group">
                ...
                <div class="row justify-content-start">
                    <div class="col-xl-8 col-lg-12 col-md-12">
                        <div class="title color-white mb-30">
                            ...
                            <h2 class="position-relative va-lb-line-w50-h2-primary pb-15 mb-30 w-75 color-white">We
                                Provide The Best Service & Support.</h2>
                            <ul>
