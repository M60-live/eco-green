            ...
            <div class="row">
                <div class="col-lg-7 col-md-9">
                    <ul>
                        ...
                        <li><i class="fa fa-envelope mr-10"></i>support@yourdomain.com</li>
                    </ul>
                </div>
                <div class="col-lg-5 col-md-3">
                    <ul class="color-white-a hover-primary a float-right">
{{--                        <li><a href="login.html">Login</a></li>--}}
{{--                        <li><a href="signup.html">Signup</a></li>--}}
                        <li><a class="quote-btn btn-primary" href="/contact">Book Consultation</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light px-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a class="nav-link" href="/services" aria-expanded="false">Services</a></li>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-widget sm-mt-0">
                    <div class="footer-logo mb-20">
                        <a href="#"><img src="images/logo_rec.png" alt="images"></a>
                    </div>
